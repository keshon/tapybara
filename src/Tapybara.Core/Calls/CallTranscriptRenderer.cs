...
public static class CallSpeakers
{
    ...
    /// </summary>
    /// <remarks>
    /// Названный голос — по имени. Неназванный при единственном отмеченном
    /// участнике — этот участник: человек сказал, что на той стороне был
    /// один, и лишний голос, найденный разделителем, — это его же голос,
    /// разваленный на два.
    /// </remarks>
